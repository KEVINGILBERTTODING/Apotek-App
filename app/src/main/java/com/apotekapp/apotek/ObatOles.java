...
public class ObatOles extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ObatAdapter(ObatOles.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog = new AlertDialog.Builder(ObatOles.this);
    ...
    private void callVolley() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(ServerAPI.URL_Read_Obat_Oles, new Response.Listener<JSONArray>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ObatOles.this, "gagal koneksi ke server, cek setingan koneksi anda", Toast.LENGTH_LONG).show();
                swipe.setRefreshing(false);
            }
        });
    ...
    private void insertDataObat() {
        Intent intent = new Intent(ObatOles.this, CreateDataObat.class);
    ...
    private void ShowDataObat(int position) {
        ...
        Intent  DetailObat  =   new Intent(ObatOles.this, DetailObatActivity.class);
    ...
    private void editDataObat (int position) {
        final DataObat obat =   itemList.get(position);
        Intent DataObat =   new Intent(ObatOles.this, UpdateDataObat.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerAPI.URL_DELETE_Obat,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        callVolley();
                        Toast.makeText(ObatOles.this, response, Toast.LENGTH_LONG).show();
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
