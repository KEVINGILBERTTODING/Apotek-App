...
public class ObatLain extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ObatAdapter(ObatLain.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog = new AlertDialog.Builder(ObatLain.this);
    ...
    private void callVolley() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(ServerAPI.URL_Read_Obat_Lain, new Response.Listener<JSONArray>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ObatLain.this, "gagal koneksi ke server, cek setingan koneksi anda", Toast.LENGTH_LONG).show();
                swipe.setRefreshing(false);
            }
        });
    ...
    private void insertDataObat() {
        Intent intent = new Intent(ObatLain.this, CreateDataObat.class);
    ...
    private void ShowDataObat(int position) {
        ...
        Intent  DetailObat  =   new Intent(ObatLain.this, DetailObatActivity.class);
    ...
    private void editDataObat (int position) {
        final DataObat obat =   itemList.get(position);
        Intent DataObat =   new Intent(ObatLain.this, UpdateDataObat.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerAPI.URL_DELETE_Obat,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        callVolley();
                        Toast.makeText(ObatLain.this, response, Toast.LENGTH_LONG).show();
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
