...
public class ObatTablet extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent kembali = new Intent(ObatTablet.this, MainActivity.class);
        ...
        adapter = new ObatAdapter(ObatTablet.this, itemList);
        ...
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog = new AlertDialog.Builder(ObatTablet.this);
        ...
        btnSirup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ObatTablet.this, ObatSirup.class);
        ...
        btnTablet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ObatTablet.this, ObatTablet.class);
                startActivity(intent);
        ...
        btnOles.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ObatTablet.this, ObatOles.class);
                startActivity(intent);
        ...
        btnLainnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ObatTablet.this, ObatLain.class);
                startActivity(intent);
    ...
    private void callVolley() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(ServerAPI.URL_Read_Obat_Tablet, new Response.Listener<JSONArray>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ObatTablet.this, "gagal koneksi ke server, cek setingan koneksi anda", Toast.LENGTH_LONG).show();
                swipe.setRefreshing(false);
            }
        });
    ...
    private void insertDataObat() {
        Intent intent = new Intent(ObatTablet.this, CreateDataObat.class);
        startActivity(intent);
    }
    ...
    private void ShowDataObat(int position) {
        ...
        Intent  DetailObat  =   new Intent(ObatTablet.this, DetailObatActivity.class);
    ...
    private void editDataObat (int position) {
        final DataObat obat =   itemList.get(position);
        Intent DataObat =   new Intent(ObatTablet.this, UpdateDataObat.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServerAPI.URL_DELETE_Obat,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        callVolley();
                        Toast.makeText(ObatTablet.this, response, Toast.LENGTH_LONG).show();
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
